...
# main config
PLUGINSLUG="restrict-content-pro-csv-user-import"
CURRENTDIR=`pwd`
MAINFILE="rcp-user-import.php" # this should be the name of your main php file in the wordpress plugin
...
SVNUSER="mindctrl" # your svn username
